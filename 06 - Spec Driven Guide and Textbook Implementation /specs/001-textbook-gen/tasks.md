...
- [ ] T026 [P] [US3] Configure Better-Auth with email/password in projects/backend/src/auth/better_auth.py
- [ ] T027 [P] [US3] Set up Prisma adapter for Better-Auth in projects/backend/src/auth/prisma_adapter.py
- [ ] T028 [US3] Implement POST /api/auth/signup endpoint in projects/backend/src/api/auth.py
- [ ] T029 [US3] Implement POST /api/auth/login endpoint in projects/backend/src/api/auth.py
- [ ] T030 [US3] Add auth cookie handling middleware in projects/backend/src/middleware/auth.py
- [ ] T031 [US3] Implement GET/PUT /api/user/profile endpoints in projects/backend/src/api/profile.py
- [ ] T032 [US3] Create signup/login UI components in projects/website/src/components/AuthForms.js
- [ ] T033 [US3] Create profile settings page in projects/website/src/pages/profile.js
...
- [ ] T034 [P] [US4] Create quiz generator agent skill in projects/agents/quiz-generator/SKILL.md
- [ ] T035 [P] [US4] Implement quiz generation function in projects/backend/src/services/quiz_generator.py
- [ ] T036 [US4] Add background parameter support to quiz generator in projects/backend/src/services/quiz_generator.py
- [ ] T037 [US4] Implement GET /api/quiz/{slug} endpoint in projects/backend/src/api/quiz.py
- [ ] T038 [US4] Implement POST /api/quiz/{slug} endpoint in projects/backend/src/api/quiz.py
- [ ] T039 [US4] Get /api/quiz/results endpoint in projects/backend/src/api/quiz.py
- [ ] T040 [US4] Build quiz UI component in projects/website/src/components/QuizComponent.js
- [ ] T041 [US4] Add quiz results display in profile page in projects/website/src/pages/profile.js
